...
"C:\Program Files\ArcGIS\Pro\bin\Python\envs\arcgispro-py3\python.exe" "C:\Scripts\OnePolygonPerAsset\CreateOnePolygonPerAsset.py" >> C:\Scripts\OnePolygonPerAsset\OnePolygonPerAsset.log
